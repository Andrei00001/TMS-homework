...
-- Started on 2022-04-20 10:52:26
...
COPY public."user" (id, name, age, gender, nationality) FROM stdin;
1	Andrei	14	m	R
2	Grigorii	20	m	R
3	Kirill	19	m	S
4	Fedor	40	m	S
...
-- Name: likes likes_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: likes likes_fk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2022-04-20 10:52:26
